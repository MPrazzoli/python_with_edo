...
def network_monitor_function():
    ...
    # manage nan value and take off (in the read module) those series with too many nan, or with observation that are not at least the 60% of the total _6_analysis period
    ...
    # la mia matrice di correlazione diventa un' adjacency matrix
     ...
     # poi costruire il _6_1_network con 
...
#
# # Project's imports
# from _3_pickle_obj.read_pickle_df import read_data_for_analysis
...
def network_function(stock_object_dictionary, ticker_list_object, important_dates):
    ...
    # setting of the number of observations used for the _6_analysis
    obs = str(200)  # number of observations to use for the _6_analysis
    ...
    ##    print(dfdf[col].iloc[:])
    # per creare il _6_1_network dalla adjacency matrix
    ##A = np.array([[1, 1], [2, 1]])
...
#     date_entry1 = input('Enter the start date for the _6_analysis in YYYY-MM-DD format')
#     date_entry2 = input('Enter the end date for the _6_analysis in YYYY-MM-DD format')
#     year1, month1, day1 = map(int, date_entry1.split('-'))
#     year2, month2, day2 = map(int, date_entry2.split('-'))
#     _6_analysis = AnalysisDatesClass(start=datetime.datetime(year1,month1, day1), end=datetime.datetime(year2,month2, day2))
#
#     # Call of the _6_1_network _6_analysis function
#     network_function(stock_object_dictionary, ticker_list_object, _6_analysis)
#
#
# # Beginning of the period_app script
# if __name__ == "__main__":
